...
const Settings = () => {
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}api/v1/auth/email-resend`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
  ...
  return (
    <>
        ...
        <div className=" w-full p-8 bg-[#ECF6E7] rounded-[20px]">
          <div className=" w-full flex flex-row justify-between items-center">
            <span className=" flex flex-col">
              <p className=" font-Afacad font-medium text-3xl text-[#101828]">
                Settings
              </p>
              <p className=" font-Afacad font-normal text-base text-[#667085]">
            ...
            <span className=" flex flex-row">
              <button
                ...
                className=" flex justify-center items-center px-6 py-3 rounded-[30px] shadow-sm bg-[#78C257] text-[#fff] text-center font-Afacad font-semibold text-base"
              >
                {loading === "NO" && "Save"}
          ...
          <div className=" flex  w-full flex-col items-center justify-center mt-6">
            ...
            <p className=" font-Afacad text-2xl font-medium mt-3 text-[#101828]">
              {name}
            </p>
            ...
            <div className=" flex w-full flex-row justify-center items-center space-x-6">
              ...
              >
                <button className=" mt-5 px-6 py-3 border border-[#667085] rounded-[20px] text-[#344054] font-Afacad text-sm font-medium">
                  Update Password
                </button>
              </Link>
              ...
              <button
                ...
                className=" mt-5 px-6 py-3 border border-[#667085] rounded-[20px] text-[#344054] font-Afacad text-sm flex justify-center items-center font-medium"
              >
          ...
          <div className=" mt-5 w-full flex flex-col">
            <label className=" w-full flex justify-between font-Afacad text-sm font-medium text-[#344054] items-center">
              ...
              <input
                ...
                className=" w-[75%] font-Afacad rounded-[8px] text-[#667085] font-normal text-base h-[45px] p-2.5"
              />
            </label>
      ...
      {verifyEmail && (
        <div className=" w-full h-[100vh] bg-[#00000046] fixed z-[9999] top-0 left-0 flex justify-center items-center">
          <div className=" bg-white p-6 flex flex-col w-[400px] items-center justify-center rounded-[20px] relative">
            <img
              ...
              alt=""
            />
            <p className=" text-center font-Afacad text-2xl font-semibold mt-1">
              Email Sent
            </p>
            <p className=" font-Afacad text-base text-[#00000099] font-normal mt-2 text-center">
              Please check your mail for a verification mail
            </p>
            <button
              onClick={() => {
                setVerifyEmail(false);
              }}
              className=" w-full bg-[#78C257] rounded-[30px] text-center font-Afacad text-base font-medium h-[45px] mt-6 text-white"
            >
              Close
            </button>
          </div>
