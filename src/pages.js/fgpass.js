        ...
        <div className=" w-full flex justify-center p-6 md:p-16 h-full items-center flex-col">
            ...
            { forgotPass && <div className=''>
                ...
                <div className='flex flex-col justify-between items-center w-full md:w-[587px] md:mt-16'>
                    ...
                    <button onClick={()=>{setForgotPass(false); setPasscode(true)}} className=' w-full bg-[#78C257] rounded-[36px] flex items-center justify-center  h-[48px] mt-[60px] text-black text-center font-Afacad text-base'>
                        { loading === 'NO' && 'Continue'}
            ...
            { passcode && <div>
                    ...
                    <div className='flex flex-col justify-between items-center w-full md:w-[587px] md:mt-16 '>
                        ...
                        <button onClick={()=>{setPasscode(false); setNewPass(true)}} className=' w-full bg-[#78C257] rounded-[36px] flex items-center justify-center  h-[48px] mt-[60px] text-black text-center font-Afacad text-base'>
                            { loading === 'NO' && 'Continue'}
                            { loading === 'YES' && <img src={ load } className=' w-6' alt="" />} 
                        </button>
                    </div>
            ...
            { newPass && <div className=''>
                ...
                <div className='flex flex-col justify-between items-center w-full md:w-[587px] md:mt-16'>
                    ...
                    <button  onClick={()=>{setNewPass(false); setForgotPass(true)}} className=' w-full bg-[#78C257] rounded-[36px] flex items-center justify-center  h-[48px] mt-[60px] text-black text-center font-Afacad text-base'>
