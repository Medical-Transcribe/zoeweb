...
const Payform = ({ clientSecret }) => {
  ...
  return (
    <form id="payment-form" className=" mt-6" onSubmit={handleSubmit}>
      ...
      />
      <button
        className=" w-full h-[45px] rounded-[36px] flex items-center justify-center bg-[#78C257] mt-3 font-Afacad text-center text-white text-base font-medium"
      ...
      {message && (
        <div
          className=" font-Afacad text-sm font-medium w-full text-left mt-3"
          id="payment-message"
        >
          {message}
        </div>
